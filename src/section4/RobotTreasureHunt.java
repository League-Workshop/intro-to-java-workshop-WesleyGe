...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		JOptionPane.showMessageDialog(null,"Good Job! Next, go to the blue triangle.");
		// 8. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
	if((robotXLocation == 880)&&(robotYLocation == 50)) {
	JOptionPane.showMessageDialog(null,"Next, find the square");
	if((robotXLocation == 90)&&(robotYLocation == 360))
	}
